...
if($query->rowCount() > 0)
{
    ...
    move_uploaded_file($_FILES["userImage"]["tmp_name"],"../Images".$_FILES["userImages"]["name"]);
    $sql  =  "INSERT INTO account (id, firstname, middlename, lastname, username, userpassword,phoneNumber, usertype, userimage, status) 
    VALUES(:CustomerId, :firstname, :middlename, :lastname, :username, :userpassword, :phoneNumber, :usertype, :userImage, 1);";
    ...
    $query->bindValue(':usertype', "customer", PDO::PARAM_STR);
...
VALUES(:CustomerId, :firstname,  :middlename, :lastname, :username, :userpassword, :meterNumber, :kebele, :houseNumber, :phoneNumber, :userImages, 1);";
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php"><?php echo htmlspecialchars($lang['Home']);?></a><i
                    class="fa fa-angle-right"></i><?php echo htmlspecialchars($lang['Register Customer']);?>
            </li>
        </ol>
        <!--grid-->
        <div class="grid-form">
            ...
            <div class="grid-form1">
                <h3><?php echo htmlspecialchars($lang['Register Customer']);?>
                </h3>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        <form class="form-horizontal" name="register" method="post" onSubmit="return checkvalidation();"
                            ...
                            <table class="table-striped mt-5 text-center" width="900px">
                                <tr>
                                    <td>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mt-4 ">
                                    <button type="submit" name="submit"
                                        class="btn btn-primary glyphicon-plus btn"><?php echo htmlspecialchars($lang['Create']);?></button>
