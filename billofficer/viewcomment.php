...
<head>
    <title>BWSSSE | View comments</title>
    ...
    <div class="container">
        ...
        <!-- <div class="left-content"> -->
            ...
            <ol class="breadcrumb">
                ...
                <?php echo htmlspecialchars($lang['Comments']);?>
            ...
            <div class="agile-grids">
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        <h2>
                            <?php echo htmlspecialchars($lang['View Comment']);?>
                                ...
                                <form method="post">
                                    <tr>
                                        ...
                                        <input name="CustomerId" type="hidden"
                                            value="<?php echo htmlentities($result->UserId);?>" />
                                        ...
                                        <input name="comments" type="hidden"
                                            value="<?php echo htmlentities($result->comments);?>" />

                                        <td><a href="reply.php?UserId=<?php echo htmlentities($result->UserId);?>">
                                                <button type="button" class="btn fa fa-refresh ">
                                                <?php echo htmlspecialchars($lang['Reply']);?>
