            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"><?php echo htmlspecialchars($lang['Home']);?></a><i
                        class="fa fa-angle-right"><a
                            href="update-customer.php"></i><?php echo htmlspecialchars($lang['Update Customer']);?></a><i
                        class="fa fa-angle-right"></i><?php echo htmlspecialchars($lang['Update Image']);?>
                            ...
                            <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="focusedinput"
                                        class="col-sm-2 control-label"><?php echo htmlspecialchars($lang['New Image']);?></label>
                                    <div class="col-sm-8">
