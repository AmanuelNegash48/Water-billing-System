...
<head>
    <title>BWSSSE | Registration Requests</title>
        ...
        <!-- <div class="left-content"> -->
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"><?php echo htmlspecialchars($lang['Home']);?></a><i
                        class="fa fa-angle-right"></i><?php echo htmlspecialchars($lang['Approve']);?>
                </li>
            </ol>
                        ...
                        <table id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo htmlspecialchars($lang['Approve']);?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="approve-cust.php?ci=<?php echo htmlentities($result->CustomerId);?>&status=<?php echo htmlentities($result->status);?>">
                                            <button type="link"
                                                class="btn btn-<?php  echo $result->status == '0' ? htmlentities('danger') :  htmlentities('primary') ;?> btn-block">
                                                <?php  echo $result->status == '0' ? htmlentities($lang['Approve']) :  htmlentities($lang['Cancel']) ;?>
                                            </button>
                                        </a>
                                    </td>
