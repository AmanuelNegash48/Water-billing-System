...
<head>
    <title>BWSSSE | Bank account</title>
                        ...
                        <table id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a
                                            href="bank-modify.php?CustomerId=<?php echo htmlentities($result->CustomerId);?>">
                                            <button type="button" class="btn fa fa-refresh ">Deposit
                                            </button></a></td>
