...
<head>
    <title>BWSSSE| Admin Change Password</title>
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php">
                ...
                <?php echo htmlspecialchars($lang['Change Password']) ?>
            </li>
        </ol>
        <!--grid-->
        <div class="grid-form">
                    ...
                    <form name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                <?php echo htmlspecialchars($lang['Current Password']) ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                <?php echo htmlspecialchars($lang['New Password']) ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                ...
                                <?php echo htmlspecialchars($lang['Confirm Password']) ?>
                            </label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">
                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            <button type="submit" name="submit" class="btn-primary btn">
                                <?php echo htmlspecialchars($lang['Submit']) ?>
                            </button>
