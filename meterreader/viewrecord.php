    ...
    <div class="page-container">
        ...
        <!-- <div class="left-content"> -->
            ...
            <ol class="breadcrumb">
                ...
                <?php echo htmlspecialchars($lang['Recorded Values']);?>
                </li>
            </ol>
            <div class="agile-grids">
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        <h2>
                            <?php echo htmlspecialchars($lang['Recorded Water Consumption Values']);?>
                        </h2>
                        <table id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo htmlspecialchars($lang['Previous Reading Value']);?></th>
                                    <th><?php echo htmlspecialchars($lang['Present Reading Value']);?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                               
                                $sql = "SELECT * FROM `sentrecorded` WHERE `previous`>=0 and`present`>0";
