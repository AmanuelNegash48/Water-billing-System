...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Profiles
                </li>
            </ol>
                    ...
                    <div class="w3l-table-info">
                        ...
                        <table id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?php echo htmlspecialchars($lang['First name']);?>:
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($result->lastname);?></th>
                                    </td>
                                </tr>
      ...
      ?>
                                ...
                                <tr>
                                    <td>
                                        <?php echo htmlspecialchars($lang['Images']);?>:
                                        <d>
                                    </td>
